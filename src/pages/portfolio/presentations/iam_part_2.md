...
title: 'Getting started with AWS - no more IAM users (part 2 - SSO)'
pubDate: 2025-05-22
description: 'How to set up AWS Identity Center (AWS SSO) for AWS accounts.'
languages: ["aws", "iam", "in_person"]
image:
    url: "/images/presentations/iam_part_2_silesia_banner.png"
...
![Meetup banner](/images/presentations/iam_part_2_silesia_banner.png)

![With attendees](/images/presentations/iam_part_2_silesia_pres.jpg)
